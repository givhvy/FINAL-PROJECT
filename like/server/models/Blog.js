// ============================================================================
// Blog.js - Model BÀI VIẾT BLOG (blog_posts collection trong Firestore)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với blog data
//
// 12 STATIC METHODS:
// CRUD: create, findById, findBySlug, findAll, update, delete
// QUERY: findByAuthor, count (pagination hỗ trợ)
// UTILS: generateSlug (title → URL-friendly), incrementViewCount, getAllTags
...
// ============================================================================
// TÓM TẮT: Model quản lý blog posts với slug routing và tag system
// KEY: db.collection('blog_posts'), generateSlug() dùng regex, client-side filtering
// cho search (Firestore không có full-text search), getAllTags() count và sort
// ============================================================================
