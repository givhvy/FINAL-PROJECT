// ============================================================================
// Newsletter.js - Model ĐĂNG KÝ NEWSLETTER (newsletter_subscribers collection)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với email newsletter subscriptions
//
// 11 STATIC METHODS: subscribe (opt-in), unsubscribe (opt-out), reactivate, isSubscribed,
// findById, findByEmail, findAll, delete, count
...
// ============================================================================
// TÓM TẮT: Model quản lý newsletter với opt-in/opt-out và reactivation
// KEY: db.collection('newsletter_subscribers'), subscribe() auto checks existing + reactivate,
// unsubscribe() sets active=false (soft delete), count() defaults to activeOnly=true
// ============================================================================
