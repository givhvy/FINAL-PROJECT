// ============================================================================
// Quiz.js - Model BÀI QUIZ (quizzes collection trong Firestore)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với quiz data
//
// 9 STATIC METHODS:
// CRUD: create, findById, findAll, update, delete
// QUERY: findByCourseId, findByLessonId
// MANAGEMENT: togglePublish, updateTotalPoints
...
// ============================================================================
// TÓM TẬT: Model quản lý quizzes với passing score và total points
// KEY: db.collection('quizzes'), dual naming (courseId/course_id, passingScore/passing_score),
// quiz có thể thuộc course hoặc lesson cụ thể
// ============================================================================
