// ============================================================================
// Progress.js - Model TIẾN ĐỘ HỌC TẬP (progress + user_progress collections)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với progress tracking
//
// 15 STATIC METHODS:
// CORE: updateLessonProgress, getLessonProgress, getByEnrollment, getCompletedLessons
// CALC: calculateCompletion, calculateStudyPoints (10pts/lesson + 100pts/course)
// SUMMARY: getCourseSummary, getUserOverallProgress, getDailyProgress, getWeeklyProgress
// MANAGEMENT: updateEnrollmentProgress, isLessonCompleted, resetCourseProgress, bulkUpdateLessons
...
// ============================================================================
// TÓM TẮT: Model tracking tiến độ với composite key format: ${userId}_${courseId}_${lessonId}
// KEY: db.collection('progress') & 'user_progress', auto update enrollment completion %,
// calculateCompletion() = completed/total lessons, batch operations với db.batch()
// ============================================================================
