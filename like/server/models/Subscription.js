// ============================================================================
// Subscription.js - Model GÓI SUBSCRIPTION (subscriptions collection)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với subscription plans (pricing tiers)
//
// STATIC METHODS: CRUD (create, findById, findAll, update, delete)
...
// ============================================================================
// TÓM TẬT: Model quản lý subscription plans (Free, Pro, Enterprise tiers)
// KEY: db.collection('subscriptions'), dual naming (monthlyPrice/monthly_price, isPopular/is_popular),
// features array chứa danh sách tính năng của mỗi tier
// ============================================================================
