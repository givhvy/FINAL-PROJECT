// ============================================================================
// Enrollment.js - Model GHI DANH KHÓA HỌC (enrollments collection)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với course enrollments
//
// STATIC METHODS: findByUserId, findByCourseId, countByCourses (batch)
...
// ============================================================================
// TÓM TẮT: Model tracking enrollments với status (active/completed/dropped)
// KEY: db.collection('enrollments'), countByCourses() chunks by 10 for Firestore 'in' limit,
// dual naming support (userId/user_id, courseId/course_id)
// ============================================================================
