// ============================================================================
// Lesson.js - Model BÀI HỌC (lessons collection trong Firestore)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với lesson data
//
// 11 STATIC METHODS:
// CRUD: create, findById, findAll, update, delete
// QUERY: findByCourseId, findByCourseIds (batch fetch để tránh N+1)
// MANAGEMENT: reorder, togglePublish, addResource, removeResource
...
// ============================================================================
// TÓM TẮT: Model quản lý bài học với backwards compatibility (old schema: content_type, content_data vs new schema: content, videoUrl)
// KEY: db.collection('lessons'), sort in memory to avoid composite index (lines 89-93),
// findByCourseIds() chunks array by 10 for Firestore 'in' limit, Promise.all + flatMap
// ============================================================================
