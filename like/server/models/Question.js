// ============================================================================
// Question.js - Model CÂU HỎI QUIZ (questions collection trong Firestore)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với question data
//
// 7 STATIC METHODS: create, findById, findAll, findByQuizId, update, delete, reorder
// 2 INSTANCE METHODS: checkAnswer (so sánh đáp án), toStudentJSON (ẩn correctAnswer)
...
// ============================================================================
// TÓM TẮT: Model quản lý câu hỏi với multiple-choice và grading logic
// KEY: db.collection('questions'), sort in memory by order, checkAnswer() hỗ trợ cả
// single và multiple correct answers, toStudentJSON() ẩn đáp án khi gửi cho student
// ============================================================================
