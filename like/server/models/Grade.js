// ============================================================================
// Grade.js - Model ĐIỂM SỐ QUIZ (grades collection trong Firestore)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với quiz scores
//
// 11 STATIC METHODS:
// CRUD: create, findById, update, delete
// QUERY: findByQuiz, findByStudent, findByUserAndQuiz
// STATS: getStudentAverage, getQuizStats (avg/min/max), calculateAverage
// VALIDATION: validate (score 0-100, required fields)
...
// ============================================================================
// TÓM TẬT: Model quản lý quiz grades với statistics và validation
// KEY: db.collection('grades'), sort in memory to avoid index, Math.max/min/round
// for stats, validate() enforces score range 0-100 và required fields
// ============================================================================
