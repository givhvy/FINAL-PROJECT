// ============================================================================
// Order.js - Model ĐƠN HÀNG (orders collection trong Firestore)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với orders (course purchases)
//
// STATIC METHODS: CRUD (create, findById, findAll, update, delete) + findByUserId
...
// ============================================================================
// TÓM TẮT: Model quản lý orders với status tracking (pending→completed/cancelled/refunded)
// KEY: db.collection('orders'), dual naming (userId/user_id, courseId/course_id),
// sort in memory to avoid index, findByUserId() for user's order history
// ============================================================================
