// ============================================================================
// Course.js - Model KHÓA HỌC (courses collection trong Firestore)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với course data
//
// 15 STATIC METHODS:
// CRUD: create, findById, findAll, update, delete
// SEARCH: search (client-side filtering)
// STATS: incrementEnrollment, updateRating, togglePublish, getPopular
// APPROVAL: approveCourse, rejectCourse, submitForApproval
// OPTIMIZATION: getAllWithDetails (batch fetch teachers + enrollments để tránh N+1)
...
// ============================================================================
// TÓM TẮT: Model quản lý khóa học với approval workflow (draft→pending→approved/rejected)
// KEY: db.collection('courses'), dual naming (instructorId/teacher_id, thumbnail/imageUrl),
// getAllWithDetails() tránh N+1 query bằng batch fetch User + Enrollment
// ============================================================================
