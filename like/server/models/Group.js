// ============================================================================
// Group.js - Model NHÓM HỌC TẬP (study_groups + group_members collections)
// ============================================================================
// Đây là MODEL CLASS định nghĩa cấu trúc và các thao tác với study groups
//
// 9 STATIC METHODS: create, findById, getAllActive (populate teacher), findByUser,
// addMember, getMemberCount, update, delete (CASCADE members+messages), validate
...
// ============================================================================
// TÓM TẮT: Model quản lý study groups với membership và CASCADE delete
// KEY: db.collection('study_groups') + 'group_members', addMember() checks duplicates,
// delete() uses batch to remove members+messages, getAllActive() populates teacher data
// ============================================================================
